    ...
    <div class="grid-box">
      ...
      <div class="grid-view">
        ...
        <div class="grids">
          <a href="#">
            <div class="grid-icon">
              <img src="../../assets/image/newfriend.png" alt="">
            </div>
            <p>信用卡还款</p>
          </a>
          <a href="#">
...
<style scope>
  ...
  .grid-view .grids a .grid-icon {
    width: 28px;
    height: 28px;
    margin: 0 auto;
  }
  .grid-view .grids a .grid-icon>img {
    width: 100%;
    height: 100%;
  }
  .grid-view .grids a>p {
